...
La fonction getData permet de tirer d'un String 
...
corrplot(corrO, title="Matrice de corrélation des valeurs Open", type="lower")

#Corrélogramme : visualisation de la matrice de corrélation des Close
corrplot(corrC, title="Matrice de corrélation des valeurs Close",type="lower")

#Corrélogramme : visualisation de la matrice de corrélation des Market.Cap
corrplot(corrM, title="Matrice de corrélation des valeurs Market.Cap", type="lower")
```
